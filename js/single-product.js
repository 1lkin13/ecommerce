...
import { singleThumbs } from "./glide2.js";
...
import tabsFunc from "./single-product/tab.js";
...
newPriceDOM.innerHTML = `$${findProduct.price.oldPrice.toFixed(2)}`;
oldPriceDOM.innerHTML = `$${findProduct.price.newPrice.toFixed(2)}`;
